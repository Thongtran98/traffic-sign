...
if __name__ == "__main__":
    vid_name = "IMG_2975.MOV"
    cap = cv2.VideoCapture("./input/"+ vid_name)
    ...
    out = cv2.VideoWriter('./output/output_videos/' + formatConvert(vid_name) + '.avi', fourcc, 20.0, (width, height))
    # out_bin = cv2.VideoWriter('./output/output_videos/bin_' + formatConvert(vid_name) + '.avi', fourcc, 20.0, (width, height))
